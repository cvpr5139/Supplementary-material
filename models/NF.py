#===========================================================
# re-implementation code of GLOW in PyTorch
# This code uses layers from : https://github.com/y0ast/Glow-PyTorch
# ==========================================================
...
from models.NF_modules import (Conv2d, Conv2dZeros, ActNorm2d, InvertibleConv1x1,
                     Permute2d, LinearZeros, SqueezeLayer,
                     Split2d, gaussian_likelihood, gaussian_sample, split_feature, uniform_binning_correction)
...
class Glow(nn.Module):
    def __init__(self, image_shape, hidden_channels, K, L, flow_coupling = 'affine', actnorm_scale = 1.,
                 flow_permutation = 'invconv',  LU_decomposed = True, y_classes=None,
                 learn_top=True, y_condition=False):
        super().__init__()
